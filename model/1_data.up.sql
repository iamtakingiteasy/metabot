...
(
  ...
  config_prefix text,
  config_color_error int,
  config_color_warn int,
  config_color_info int,
...
(
  ...
  config_admins_type int,
  config_admins_permission_mask int,
...
(
  ...
  config_restrict_rules_event int,
  ...
  config_restrict_rules_action int,
...
(
  ...
  channels_name text,
  channels_type int,
  channels_bitrate int,
  channels_parent_discord_id text,
  channels_position int,
  channels_nsfw boolean,
  channels_topic text,
  channels_user_limit int,
...
(
  ...
  embeds_thumbnail_width int,
  embeds_thumbnail_height int,
  embeds_thumbnail_url text,
  embeds_thumbnail_proxy_url text,
  embeds_image_width int,
  embeds_image_height int,
  embeds_image_url text,
  embeds_image_proxy_url text,
  embeds_video_width int,
  embeds_video_height int,
